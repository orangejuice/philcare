    ...
    <div className="font-sans">
      ...
      <header className="min-h-[calc(100vh-4rem)] flex relative overflow-hidden">
        ...
        <div className="flex flex-col gap-4 px-20 py-40 relative z-10 justify-evenly items-center text-center lg:justify-normal lg:items-start lg:text-left lg:max-w-2xl">
          ...
          <motion.h1 initial="hidden" whileInView="visible" viewport={{once: true}} variants={fadeIn} transition={{duration: 0.6}}
          ...
          <motion.p initial="hidden" whileInView="visible" viewport={{once: true}} variants={fadeIn} transition={{duration: 0.6, delay: 0.2}}
      ...
      <section id="services" className="py-10 bg-white xl:mx-[15vw] xl:rounded-xl xl:shadow-2xl xl:-translate-y-2/3 xl:mb-[-10%]">
        <div className="flex flex-col gap-10 px-6">
          <motion.div className="lg:text-center" initial="hidden" whileInView="visible" viewport={{once: true}} variants={fadeIn} transition={{duration: 0.6}}>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {[
              ...
              <motion.div key={service.title} initial="hidden" whileInView="visible" viewport={{once: true}} variants={fadeIn} transition={{duration: 0.6, delay: index * 0.2}}>
                <dt>
          ...
          <div className="mt-10">
            <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-x-8 md:gap-y-10">
              {[
                ...
                <motion.div key={benefit.name} className="relative"
                  initial="hidden" whileInView="visible" viewport={{once: true}} variants={fadeIn} transition={{duration: 0.6, delay: index * 0.2}}>
                  <dt>

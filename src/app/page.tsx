        ...
        <div className="grid md:grid-cols-2 items-start gap-16">
          ...
          <motion.div {...viewPortFadeIn(0.4)} className="text-blue-900 space-y-8">
            ...
            <div className="space-y-6">
              ...
              <p className="flex">
<<<<<<< HEAD
                <Mail className="mr-4 shrink-0 w-5 h-5 text-blue-500"/> Customer Live in Inquiry : inquiries@philcare.ie <br/>Care Worker Application : jobs@philcare.ie
=======
...
>>>>>>> 1a2d8e1d3f435b7cbde2d75914e8690cdf2c402c
              </p>
